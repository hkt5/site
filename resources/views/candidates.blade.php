                    ...
                    <div class="header-column">
                        <div class="header-row">
                            <div class="header-logo">
                                <a href="index.html">
                                    <img alt="SilenceOntheWire" width="100" height="48" data-sticky-width="82" data-sticky-height="40" src="img/logo.png">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        <h1>Becomming a <strong>Candidate</strong></h1>
                        <span class="sub-title">The very best treatment from the moment your register with us.</span>
                    </div>
            ...
            <div class="row py-4">
                <div class="col-lg-7 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="650">
                    ...
                    <form id="contactFormAdvanced" action="#contact-sent" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold text-dark text-2">Your experience</label>
                            ...
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold text-dark text-2">Your skill</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="font-weight-bold text-dark text-2">Expected salary</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="font-weight-bold text-dark text-2">Insert other documents (zip/rar package or documents)</label>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="overflow-hidden mb-1">
                        <h4 class="text-primary mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">Becoming a <strong>Candidate</strong></h4>
                    </div>
                    <div class="overflow-hidden mb-3">
                        <p class="lead text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">The very best treatment from the moment your register with us.</p>
                    </div>
                    <div class="overflow-hidden">
                        <p class="mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600">A key principle of what we aspire to deliver is excellence in service to our candidates.</p>
                    </div>

                    <div class="overflow-hidden">
                        <p class="mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">We aim to provide the utmost care to the people that we are helping to find their next position. We aim to provide deep expert knowledge and career guidance on your career options. We will always provide frank and prompt feedback on your applications and we will stay in touch into the future.</p>
                    </div>
